...
def init():
      ...
      #glClearColor(0.1, 0.2, 0.0, 1.0) # putrified
...
def plotpoints():
      ...
      #glBegin(GL_LINES)#8.2     #glBegin(GL_LINE_STRIP)# QUESTION 7.2     #glBegin(GL_LINES)# QUESTION  7  #
      glBegin(GL_POINTS) # QUESTION 6
      glVertex2f(0.0, 0.0)
